...
contract Hangman is Verifier {
    ...
    /**
     * @notice Creates new game. Persists hash of the secret word that host picked and the length of the word.
     ...
     *  Elements [9-24] - a mask representing the length of the word. For example, for word "Hello" it will be 0000011111111111
     *  For ZK proof it means that first five symbols of the word input are not '0' (not equal to Element 8).
     */
    ...
    /**
     * @notice Suggests a letter that player thinks is in the word. Can only try one that wasn't guessed before
     * @param gameId Game for which guess is submitted
    ...
    /**
     * @notice Verifies whether a letter exist in the word and captures letter's positions within the word. 
